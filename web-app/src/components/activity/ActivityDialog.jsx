    ...
    return (
        ...
        >
            ...
            <DialogContent >
                ...
                <br />
                <LapChart selectedLaps={selectedLaps} lapData={data} activity={activity} powerMovingAvg={powerMovingAvg} setFullLapStream={setFullLapStream} isInEditMode={isInEditMode} />
